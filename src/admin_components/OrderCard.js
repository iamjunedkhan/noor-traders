...
const OrderCard = ({
    ...
    shipping_address
        ...
        return (
        <div className=" p-6 w-full md:w-2/5 rounded-lg productCard_shadow flex flex-col items-start my-6  md:m-12">
            ...
            <div className="flex items-center justify-between flex-wrap pb-4 mt-3 border-b-2 border-gray-100  w-full">
                <span className="inline-block py-1 px-2 rounded bg-rose-50 text-rose-500 text-lg font-medium tracking-widest my-2">Status:{order_status}</span>
