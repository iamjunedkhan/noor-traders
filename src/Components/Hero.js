...
const Hero = () => {
    return (
        <div className='relative  h-91'>
            ...
            <div className='mt-4  '>
                <button className='flex items-center gap-1  hover:font-bold transition-all duration-150 text-sm md:text-xl text-black bg-white px-5 py-2 rounded-lg'>Explore Menu <BsArrowRight className='relative top-[2px]' /></button>
            </div>
            </div>
        </div>
    )
